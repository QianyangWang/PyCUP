...
def objective_function(X,read_start,read_end,read_step):
    ...
    proj_dir = r"project"
    inp_path = proj_dir + r"\Example1-Post.inp"
    rpt_path = proj_dir + r"\Example1-Post.rpt"
    swmm_out_path = proj_dir + r"\Example1-Post.out"
...
if __name__ == "__main__":
    ...
    cp.GLUE.run(500, 11, lb=lb, ub=ub, fun=objective_function,
