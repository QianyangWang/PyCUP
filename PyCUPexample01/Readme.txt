...
4. the model executable and the model project file are located in the 'project' folder. 
...
3. SciPy
4. matplotlib
5. pyswmm (tested on version 1.1.1)
6. swmm-api (0.2.0.18.3)
7. swmm-toolkit (0.8.2)
8. win32api
9. win32event
10. win32process
11. win32con
12. win32com
13. Anaconda 3 environment (tested)
