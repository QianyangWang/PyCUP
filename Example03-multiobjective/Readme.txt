This is an example project that calibrates an SWMM model using multi-processing NSGA-II
...
3. run the Calibrate.py for model calibration, run the PostProcessing.py to plot the Pareto front.
